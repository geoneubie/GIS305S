...
def extract():
    ...
    r = requests.get("https://docs.google.com/spreadsheets/d/e/2PACX-1vRJ-grk0VheQtXnfo2YefVsJ2wVz-7-VfPtlfkXD9DOoX2nbNM9SFsfYx20LKnboBQfOjcyo3fioyvt/pub?output=csv")
    r.encoding = "utf-8"
    data = r.text
