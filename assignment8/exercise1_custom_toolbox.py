...
def buffer_layer(input_gdb, input_layer, dist):
    ...
    output_layer = r"C:\Users\Owner\Desktop\GIS305\GIS305Ass#1\GIS305Ass#1.gdb\\" + input_layer + "_buf"
...
def main():
    ...
    arcpy.env.workspace = r"C:\Users\Owner\Desktop\GIS305\GIS305Ass#1\GIS305Ass#1.tbx\Model\\"
    arcpy.env.overwriteOutput = True

    # Buffer cities
    input_gdb = r"C:\Users\Owner\Desktop\GIS305\GIS305Ass#1\GIS305Ass#1.gdb\\"
    ...
    aprx = arcpy.mp.ArcGISProject(
        r"c:\Users\Owner\Desktop\GIS305\GIS305Ass#1\GIS305Ass#1.ap"
        r"rx")
    map_doc = aprx.listMaps()[0]
    map_doc.addDataFromPath(rf"C:\Users\Owner\Desktop\GIS305\GIS305Ass#1\GIS305Ass#1.gdb\{intersect_lyr_name}")
