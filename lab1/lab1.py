...
def main():
    ...
    arcpy.Select_analysis(WNV_Spatial, 'at_risk_addresses', "Join_Count > 0")
    count_lyr = r"C:\Users\lbcem\Desktop\GIS305\lab1\WestNileOutbreak\WestNileOutbreak.gdb\at_risk_addresses"
    result = arcpy.GetCount_management(count_lyr)
    print("There are " + result[0] + " homes in the danger area.")

    # Add new layer to map
    map_doc.addDataFromPath(r"C:\Users\lbcem\Desktop\GIS305\lab1\WestNileOutbreak\WestNileOutbreak.gdb\at_risk_addresses")
    aprx.save()
